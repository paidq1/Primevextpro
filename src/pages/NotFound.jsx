...
export default function NotFound() {
  ...
  return (
    <div style={{ minHeight: 'calc(var(--vh, 1vh) * 100)', background: '#0e1628', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', fontFamily: "'Segoe UI', sans-serif" }}>
