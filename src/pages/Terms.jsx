...
export default function Terms() {
  ...
  const sections = [
    { title: '1. Acceptance of Terms', content: 'By accessing and using VertexTrade Pro, you accept and agree to be bound by the terms and provisions of this agreement. If you do not agree to these terms, please do not use our platform.' },
    ...
    { title: '5. KYC & AML Policy', content: 'VertexTrade Pro complies with Know Your Customer (KYC) and Anti-Money Laundering (AML) regulations. Users must complete identity verification before making withdrawals. We may request government-issued ID and proof of address.' },
    ...
    { title: '9. Intellectual Property', content: 'All content, trademarks, and intellectual property on VertexTrade Pro are owned by or licensed to us. You may not copy, reproduce, or distribute any content without prior written permission.' },
    { title: '10. Limitation of Liability', content: 'VertexTrade Pro shall not be liable for any indirect, incidental, or consequential damages arising from your use of our platform. Our total liability shall not exceed the amount deposited in your account.' },
    ...
    <div style={{ minHeight: '100vh', background: '#0e1628', color: 'white', fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '10px', lineHeight: '1.8', marginBottom: '32px', background: '#1a2e4a', padding: '16px', borderLeft: '3px solid #6366f1' }}>
          Please read these Terms and Conditions carefully before using VertexTrade Pro. These terms govern your use of our platform and services.
        </p>
        {sections.map((s, i) => (
      ...
      <div style={{ background: '#132035', padding: '16px 20px', textAlign: 'center', borderTop: '1px solid rgba(255,255,255,0.08)', marginTop: '40px' }}>
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '8px' }}>© 2026 VertexTrade Pro. All rights reserved.</span>
      </div>
    </div>
  );
}
