        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px', marginBottom: '20px' }}>
          {stakePlans.map((plan, i) => (
            <div key={i} onClick={() => { setSelectedPlan(plan); setAmount(String(plan.min)); }}
              style={{ background: selectedPlan?.name === plan.name ? plan.bg : '#252d3d', border: `1px solid ${selectedPlan?.name === plan.name ? plan.color : 'rgba(255,255,255,0.08)'}`, padding: '12px', cursor: 'pointer', transition: 'all 0.2s' }}>
        ...
        <div style={{ display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ marginBottom: '12px' }}>
              ...
              <div style={{ background: '#252d3d', border: '1px solid rgba(255,255,255,0.08)', padding: '8px 10px', fontSize: '9px', color: selectedPlan ? selectedPlan.color : 'rgba(255,255,255,0.3)' }}>
