      ...
      <div style={{ padding: '16px' }}>
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          {error && <div style={{ color: '#ef4444', fontSize: '9px' }}>{error}</div>}
                    ...
                    {/* QR Image */}
          <div style={{ overflow: 'hidden', width: '100%', height: '480px' }}>
            <img src="/qr-usdt.jpg" alt="USDT QR" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center', transform: 'scale(1.08)', transformOrigin: 'center' }} />
          </div>
