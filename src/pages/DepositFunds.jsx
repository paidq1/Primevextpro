...
export default function DepositFunds() {
  ...
  <div style={{ width: '180px', flexShrink: 0, background: '#0d1117', border: '1px solid rgba(255,255,255,0.08)', padding: '14px' }}>
    ...
    {[['Bank Name','VertexTrade Bank'],['Account Name','VertexTrade Pro Ltd'],['Account Number','0123456789'],['Routing No.','021000021'],['SWIFT Code','PRVSTUS33']].map(([k,v]) => (
      ...
      {showSuccess && (
        <>
          ...
          <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex: 151, background: 'white', padding: '36px 28px', width: '320px', textAlign: 'center', borderRadius: '8px' }}>
            ...
            <div style={{ color: '#555', fontSize: '12px', marginBottom: '24px', lineHeight: '1.8' }}>Your deposit has been submitted successfully. It will reflect in your account shortly.</div>
            <div style={{ color: '#ef4444', fontSize: '8px', marginBottom: '8px', minHeight: '14px' }}>{error}</div>
