...
export default function NewTrade() {
  ...
  useEffect(() => {
    ...
    fetch('https://vertextrades.onrender.com/api/user/dashboard', { headers: { Authorization: `Bearer ${token}` } })
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      autosize: true, symbol: symbol.tv, interval: '60', timezone: 'Etc/UTC',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0f1e', fontFamily: "'Segoe UI', sans-serif", color: 'white', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Chart */}
      <div style={{ height: '75vh', width: '100%', flexShrink: 0, position: 'relative' }}>
