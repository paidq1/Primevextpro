  ...
  return (
    <div style={{ minHeight: '100vh', background: '#1e2538', fontFamily: "'Segoe UI', sans-serif", color: 'white' }}>
      <div style={{ background: '#141824', padding: '10px 16px', display: 'flex', alignItems: 'center', gap: '10px', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <span style={{ color: 'rgba(255,255,255,0.3)', fontSize: '9px', marginLeft: '8px' }}>/ Live Trading</span>
      </div>
      <div style={{ padding: '24px 16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '24px' }}>
          <div style={{ width: '4px', height: '24px', background: '#f59e0b', borderRadius: '2px' }}/>
          <h1 style={{ color: 'white', fontSize: '14px', fontWeight: '700', margin: 0 }}>Live Trading</h1>
        </div>
