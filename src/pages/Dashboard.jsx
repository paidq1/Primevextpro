...
{/* Main Content */}
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {/* Admin Message */}
        {u.adminMessage && (
          <div style={{ background: 'rgba(245,158,11,0.15)', border: '1px solid #f59e0b', padding: '6px 12px', display: 'flex', alignItems: 'center', gap: '6px', fontSize: '8px', color: '#f59e0b', overflow: 'hidden' }}>
