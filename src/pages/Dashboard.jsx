      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '12px', minWidth: 0 }}>
            ...
            {/* Welcome Card */}
            <div style={{ background: '#1e293b', border: 'none', borderRadius: '12px', padding: '14px 12px', marginBottom: '20px', textAlign: 'center' }}>
              ...
              <div style={{ background: '#0f172a', borderRadius: '10px', padding: '10px', marginBottom: '8px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '20px' }}>
              {stats.map((s, i) => (
                <div key={i} style={{ background: '#252d3d', border: 'none', padding: '12px 10px', minHeight: '90px', background: '#1e293b', borderRadius: '10px' }}>
            ...
            <BTCChart />
            {/* Transaction List */}
            <div style={{ background: '#1e293b', border: 'none', borderRadius: '12px', padding: '10px', marginBottom: '20px' }}>
        ...
        <div style={{ padding: '0 12px 20px' }}>
          <div style={{ background: '#1e293b', border: 'none', borderRadius: '12px', padding: '14px' }}>
