      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '12px', minWidth: 0 }}>
            ...
            {/* Welcome Card */}
            <div style={{ background: 'rgba(255,255,255,0.05)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: '16px', padding: '14px 12px', marginBottom: '20px', boxShadow: '0 8px 20px rgba(0,0,0,0.3)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
              <svg style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', opacity: 0.12, pointerEvents: 'none' }} xmlns='http://www.w3.org/2000/svg'>
                <defs>
                  <pattern id='mesh' x='0' y='0' width='40' height='40' patternUnits='userSpaceOnUse'>
                    ...
                    <circle cx='40' cy='0' r='1.5' fill='#6366f1'/>
                    <circle cx='0' cy='40' r='1.5' fill='#6366f1'/>
                    <line x1='0' y1='0' x2='40' y2='40' stroke='#818cf8' strokeWidth='0.3' opacity='0.5'/>
                  </pattern>
                </defs>
                <rect width='100%' height='100%' fill='url(#mesh)'/>
              </svg>
              <div style={{ position: 'absolute', top: '-40px', right: '-40px', width: '150px', height: '150px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(99,102,241,0.2) 0%, transparent 70%)', pointerEvents: 'none' }}></div>
