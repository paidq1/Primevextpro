        ...
        <div style={{ flex: 1, display: 'flex', overflow: 'hidden' }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '12px', minWidth: 0 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,0.05)', backdropFilter: 'blur(10px)', WebkitBackdropFilter: 'blur(10px)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '14px 12px', marginBottom: '20px', boxShadow: '0 4px 20px rgba(0,0,0,0.3)', textAlign: 'center' }}>
              ...
              <div style={{ background: 'linear-gradient(135deg, #0f1729 0%, #1a0f3d 50%, #0f1729 100%)', border: '1px solid rgba(99,102,241,0.4)', borderRadius: '10px', padding: '10px', marginBottom: '8px', boxShadow: '0 0 40px rgba(99,102,241,0.2) inset' }}>
