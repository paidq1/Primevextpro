...
const cryptoPlans = [
  { name: 'Bitcoin',     symbol: 'BTC',  roi: '28.75%', minRoi: 28.75, color: '#f97316', bg: '#f9731620', emoji: '₿' },
  { name: 'Ethereum',    symbol: 'ETH',  roi: '30%',    minRoi: 30,    color: '#6366f1', bg: '#6366f120', emoji: 'Ξ' },
  { name: 'Litecoin',    symbol: 'LTC',  roi: '24.75%', minRoi: 24.75, color: '#94a3b8', bg: '#94a3b820', emoji: 'Ł' },
  { name: 'BNB',         symbol: 'BNB',  roi: '28%',    minRoi: 28,    color: '#f59e0b', bg: '#f59e0b20', emoji: 'B' },
  { name: 'Tether USD',  symbol: 'USDT', roi: '24.75%', minRoi: 24.75, color: '#22c55e', bg: '#22c55e20', emoji: '₮' },
  { name: 'Solana',      symbol: 'SOL',  roi: '32%',    minRoi: 32,    color: '#a855f7', bg: '#a855f720', emoji: '◎' },
  { name: 'XRP',         symbol: 'XRP',  roi: '22.5%',  minRoi: 22.5,  color: '#22d3ee', bg: '#22d3ee20', emoji: '✕' },
  { name: 'Cardano',     symbol: 'ADA',  roi: '20%',    minRoi: 20,    color: '#3b82f6', bg: '#3b82f620', emoji: '₳' },
];
              ...
              {cryptoPlans.map((c, i) => (
                <div key={i} onClick={() => setSelected(c)}
                  ...
                  <div style={{ width: '52px', height: '52px', borderRadius: '50%', background: c.bg, border: `2px solid ${c.color}40`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <span style={{ color: c.color, fontSize: '22px', fontWeight: '900' }}>{c.emoji}</span>
                  </div>
                  {/* Info */}
                  <div style={{ flex: 1 }}>
          ...
          <div>
            ...
            <div style={{ background: '#132035', border: `1px solid ${selected.color}30`, padding: '16px', marginBottom: '16px', display: 'flex', alignItems: 'center', gap: '14px' }}>
              <div style={{ width: '52px', height: '52px', borderRadius: '50%', background: selected.bg, border: `2px solid ${selected.color}40`, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <span style={{ color: selected.color, fontSize: '22px', fontWeight: '900' }}>{selected.emoji}</span>
              </div>
              <div>
