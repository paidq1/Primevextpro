    ...
    <><section id="contact" ref={ref} style={{ background: '#0e1420', width: '100%', boxSizing: 'border-box', padding: '12px', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'row', gap: '12px', position: 'relative', zIndex: 1 }}>
        ...
        <div className="scroll-anim" style={{ flex: '0 0 52%', minWidth: 0 }}>
          ...
          <p style={{ color: 'white', fontSize: 'clamp(7px, 1.8vw, 9px)', lineHeight: '1.6', marginBottom: '4px' }}>
          ...
          <div style={{ marginBottom: '4px' }}>
            <label style={{ color: 'white', fontSize: 'clamp(7px, 1.8vw, 9px)', fontWeight: '600', display: 'block', marginBottom: '4px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                style={{ width: '100%', background: 'rgba(44,62,80,0.25)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '4px', padding: '6px 32px 6px 10px', color: 'white', fontSize: 'clamp(7px, 1.8vw, 9px)', boxSizing: 'border-box', outline: 'none' }}
              />
          ...
          <div style={{ marginBottom: '6px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <textarea
                ...
                rows={2}
                style={{ width: '100%', background: 'rgba(44,62,80,0.25)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '4px', padding: '6px 32px 6px 10px', color: 'white', fontSize: 'clamp(7px, 1.8vw, 9px)', boxSizing: 'border-box', outline: 'none', resize: 'none' }}
              />
          ...
          <button onClick={handleSubmit} disabled={submitting} style={{
            ...
            borderRadius: '4px', color: 'white', fontSize: 'clamp(8px, 2vw, 10px)', fontWeight: '600',
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <h3 style={{ color: 'white', fontWeight: '700', fontSize: 'clamp(12px, 3vw, 16px)', marginBottom: '4px' }}>Information</h3>
            <div style={{ width: '28px', height: '2px', background: '#6366f1', marginBottom: '4px' }} />
            <p style={{ color: 'white', fontSize: 'clamp(7px, 1.8vw, 9px)', lineHeight: '1.6', marginBottom: '6px' }}>
            ...
            {[
              { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', text: 'support@vertextradeprox.cc' },
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                ...
                <span style={{ color: 'white', fontSize: 'clamp(7px, 1.8vw, 9px)' }}>{item.text}</span>
              </div>
            ))}
          </div>
        </div>
