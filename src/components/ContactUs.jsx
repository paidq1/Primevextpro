      ...
      <div style={{ display: 'flex', flexDirection: 'row', gap: '12px', position: 'relative', zIndex: 1 }}>
        ...
        <div className="scroll-anim" style={{ flex: '0 0 52%', minWidth: 0 }}>
          ...
          <div style={{ marginBottom: '4px' }}>
            <label style={{ color: 'white', fontSize: '8px', fontWeight: '600', display: 'block', marginBottom: '4px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <input
                ...
                style={{ width: '100%', background: 'rgba(44,62,80,0.25)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '4px', padding: '6px 32px 6px 10px', color: 'white', fontSize: '8px', boxSizing: 'border-box', outline: 'none' }}
              />
          ...
          <div style={{ marginBottom: '6px' }}>
            ...
            <div style={{ position: 'relative' }}>
              <textarea
                ...
                rows={2}
                style={{ width: '100%', background: 'rgba(44,62,80,0.25)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '4px', padding: '6px 32px 6px 10px', color: 'white', fontSize: '8px', boxSizing: 'border-box', outline: 'none', resize: 'none' }}
              />
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <h3 style={{ color: 'white', fontWeight: '700', fontSize: '14px', marginBottom: '4px' }}>Information</h3>
            <div style={{ width: '28px', height: '2px', background: '#6366f1', marginBottom: '4px' }} />
            <p style={{ color: 'white', fontSize: '8px', lineHeight: '1.6', marginBottom: '6px' }}>
            ...
            {[
              ...
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                ...
                <span style={{ color: 'white', fontSize: '8px' }}>{item.text}</span>
              </div>
            ))}
          </div>
        </div>
