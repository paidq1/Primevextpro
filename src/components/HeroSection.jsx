    ...
    <nav style={{ position: "relative", zIndex: 9999 }} className="relative z-20 w-full px-3 pt-2 pb-2">
      <div className="flex items-center w-full">
        ...
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <div style={{ width: "clamp(12px, 3vw, 16px)", height: "clamp(12px, 3vw, 16px)" }}>
    ...
    <section id="home" className="relative pt-0 pb-4 bg-[#151c27] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-row items-start gap-2 pt-3 px-3">
        ...
        <div className="flex-1 min-w-0 space-y-2 pt-1">
          ...
          <div data-aos="fade-up" data-aos-delay="100" className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-blue-500/10 border border-blue-500" style={{ fontSize: "clamp(9px, 2.2vw, 12px)" }}>
            <span className="w-1 h-1 bg-blue-500 rounded-full animate-pulse"></span>
            Trading, Crypto, Staking & Investing
          </div>

          <h1 data-aos="fade-up" data-aos-delay="200" style={{ fontSize: "clamp(15px, 4vw, 22px)" }} className="font-bold leading-tight text-white">
            Empower Your <span className="text-blue-500">Financial</span> Future with Cryptocurrency and Forex Trading
          </h1>

          <p data-aos="fade-up" data-aos-delay="300" className="text-gray-400 leading-relaxed" style={{ fontSize: "clamp(9px, 2.2vw, 12px)" }}>
          ...
          <div className="flex gap-2 pt-1">
            <button style={{ fontSize: "clamp(9px, 2.2vw, 12px)" }} className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-none font-bold transition-colors" onClick={onGetStarted}>
              Get Started
            </button>
            <button style={{ fontSize: "clamp(9px, 2.2vw, 12px)" }} className="group bg-white/5 hover:bg-white/10 border border-white/20 px-4 py-2 rounded-none font-bold flex items-center gap-1 transition-all" onClick={() => window.location.href="/signin"}>
              Learn More
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-1 text-gray-300" style={{ fontSize: "clamp(8px, 2vw, 11px)" }}>
