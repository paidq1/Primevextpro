...
const awards = [
  { num: '01.', title: 'Century International Quality Gold ERA Award', org: '- Fintech Innovation Summit', desc: 'The prestigious award was given to PrimeVest Pro Trades in recognition of our outstanding commitment to Quality and Excellence, particularly in the realm of Customer Satisfaction.', img: '/award1.png' },
  ...
  { num: '03.', title: 'Most Reliable Binary Options Broker', org: '- MasterForex-V Academy', desc: "Our first priority is the security of our clients' funds. This was recognized by the experts at MasterForex-V, who awarded PrimeVest Pro Trades the title of Most Trusted Binary Options Broker.", img: '/award3.png' },
  ...
  { num: '05.', title: "World's Leading Binary Options Broker", org: '- MasterForex-V Academy', desc: "At the same MasterForex-V PrimeVest Pro was awarded for being the World's Leading Binary Options Broker. The perfection in our service and product was recognized by the experts of the conference in 2014.", img: '/award5.png' },
