    ...
    <>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'row', gap: '16px', alignItems: 'flex-start' }}>
          ...
          {/* Left Panel */}
          <div style={{
            flex: '0 0 42%', minWidth: 0, boxSizing: 'border-box', alignSelf: 'stretch',
            background: '#141e2e',
            ...
            <h2 style={{ color: 'white', fontWeight: '700', fontSize: '11px', lineHeight: '1.4', margin: 0 }}>
            ...
            <p style={{ color: 'rgba(255,255,255,0.65)', fontSize: '7px', lineHeight: '1.5', margin: 0 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              {features.map((f, i) => (
                <div key={i} style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                  ...
                  <div>
                    <div style={{ color: 'white', fontWeight: '600', fontSize: '8px', marginBottom: '1px' }}>{f.title}</div>
                    <div style={{ color: 'rgba(255,255,255,0.55)', fontSize: '7px', lineHeight: '1.4' }}>{f.description}</div>
                  </div>
                </div>
              ))}
            </div>
            ...
            <button style={{
              ...
              padding: '10px 12px', borderRadius: '0px', fontSize: '9px',
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginBottom: '6px' }}>
                <span style={{ color: 'white', fontWeight: '600', fontSize: '10px' }}>Suggested Links</span>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                {suggestedLinks.map((link, i) => (
                  <a key={i} href={link.url} target="_blank" rel="noopener noreferrer" style={{
                    ...
                    <div>
                      <div style={{ color: '#818cf8', fontSize: '8px', fontWeight: '600', marginBottom: '1px' }}>{link.title}</div>
                      <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '7px' }}>{link.duration} ~ {link.channel}</div>
                    </div>
                  </a>
                ))}
              </div>
            ...
            <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
              <img
                ...
                alt="James Clark"
                style={{ width: '44px', height: '44px', flexShrink: 0, borderRadius: '50%', objectFit: 'cover', objectPosition: '50% 5%', background: 'white', border: '3px solid #3b82f6' }}
              />
              <div>
                <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '8px', lineHeight: '1.6', margin: '0 0 4px 0', fontStyle: 'normal' }}>
                ...
                <span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '7px' }}>~ James Clark</span>
              </div>
            </div>
