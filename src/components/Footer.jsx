    ...
    <footer style={{ background: '#151c27', width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{ color: 'white', fontSize: '8px', fontWeight: '700', letterSpacing: '2px' }}>VERTEXTRADE <span style={{ color: '#6366f1' }}>PRO</span></span>
          <span style={{ color: 'white', fontSize: '8px' }}>© 2025 VertexTrade Pro All rights reserved</span>
        </div>
      </div>
