...
const Footer = () => {
  ...
  return (
    <footer style={{ background: '#151c27', width: '100%', boxSizing: 'border-box' }}>
      ...
      {/* Main Footer */}
      <div style={{ padding: '24px 16px', display: 'flex', flexDirection: 'row', gap: '16px', flexWrap: 'wrap' }}>

        {/* Contact */}
        <div style={{ flex: '1 1 120px', minWidth: 0 }}>
          <h3 style={{ color: 'white', fontWeight: '700', fontSize: '10px', marginBottom: '6px' }}>Contact</h3>
          <div style={{ width: '28px', height: '2px', background: '#6366f1', marginBottom: '12px' }} />

          {[
            { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', label: 'Email', value: 'support@primevestprox.cc' },
            ...
            <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
              <div style={{ width: '22px', height: '22px', borderRadius: '0px', background: 'rgba(99,102,241,0.15)', border: '1px solid rgba(99,102,241,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                <svg width="12" height="12" fill="none" stroke="#818cf8" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d={item.icon} />
                </svg>
              </div>
              <div>
                <div style={{ color: 'white', fontSize: '7px', fontWeight: '600' }}>{item.label}</div>
                <div style={{ color: '#94a3b8', fontSize: '6px' }}>{item.value}</div>
              </div>
            </div>
          ))}
          ...
          <div style={{ display: 'flex', gap: '8px', marginTop: '12px' }}>
            {[
              ...
              <div key={i} style={{ width: '22px', height: '22px', borderRadius: '0px', border: '1px solid rgba(99,102,241,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>
        ...
        {/* Newsletter */}
        <div style={{ flex: '1 1 120px', minWidth: 0 }}>
          <h3 style={{ color: 'white', fontWeight: '700', fontSize: '10px', marginBottom: '6px' }}>Newsletter</h3>
          <div style={{ width: '28px', height: '2px', background: '#6366f1', marginBottom: '12px' }} />
          <p style={{ color: 'white', fontSize: '7px', lineHeight: '1.6', marginBottom: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '0' }}>
            <div style={{ flex: 1 }}>
              <label style={{ color: 'white', fontSize: '7px', fontWeight: '600', display: 'block', marginBottom: '4px' }}>Your Email <span style={{ color: '#ef4444' }}>*</span></label>
        ...
        {/* Quick Links */}
        <div style={{ flex: '1 1 120px', minWidth: 0 }}>
          <h3 style={{ color: 'white', fontWeight: '700', fontSize: '10px', marginBottom: '6px' }}>Quick Links</h3>
          <div style={{ width: '28px', height: '2px', background: '#6366f1', marginBottom: '12px' }} />
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', padding: '12px 16px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{ color: 'white', fontSize: '8px', fontWeight: '700', letterSpacing: '2px' }}>PRIMEVEST <span style={{ color: '#6366f1' }}>PRO</span></span>
          <span style={{ color: 'white', fontSize: '8px' }}>© 2025 PrimeVest Pro All rights reserved</span>
        </div>
      </div>
